...
export default {
  ...
  mounted () {
    ...
    this.minLogo = this.$i18n.locale=='zh-CN'?localStorage.getItem('ccsNameCnShort'):localStorage.getItem('ccsNameEnShort')
    this.maxLogo = this.$i18n.locale=='zh-CN'?localStorage.getItem('ccsNameCn'):localStorage.getItem('ccsNameEn')
  }
}
</script>
