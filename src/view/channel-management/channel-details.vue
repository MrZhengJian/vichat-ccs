  ...
  data () {
    return {
      ...
      columns: [
        ...
        {
          title: this.$t('user_table_col_role'),
          key: 'adminGrade',
          ellipsis: true,
          render: (h, params) => {
            return h('Tooltip', {
      ...
      adminGradeList: [
        {
          value: 5,
          desc: this.$t('employee_type_List3')
        },
        {
          value: 10,
          desc: this.$t('employee_type_List2')
        }
      ],
      ...
      if (this.personData) {
        for (let i = 0; i < this.personData.length; i++) {
          ...
          switch (this.personData[i].adminGrade) {
            case 5:
              this.personData[i].adminGrade = this.$t('employee_type_List3')
              break
            case 10:
              this.personData[i].adminGrade = this.$t('employee_type_List2')
              break
          }
